...
public class Board extends Canvas{
	...
	public void paint(Graphics g){
		if(!this.end){
			...
			if(!this.hasPressedEnter && ball.isInterlude()){
				g.drawString("PULSA ENTER", GameWindow.DIM_FRAME_X/2 - 150, 100); //TODO CAMBIADO X
				g.drawString("PULSA ENTER", GameWindow.DIM_FRAME_X/2 + 65, 100);
			}
		}
		else{
	...
	public boolean setNewPoint(){
		if(ball.getPosX() <= 0) {
			...
			ball.setPosY(ball.generateInitPosition());//TODO
